...
submit.addEventListener('click',(e)=>{e.preventDefault(); calculateEMI();}) //The preventDefault() method cancels the event if it is cancelable, meaning that the default action that belongs to the event will not occur.
